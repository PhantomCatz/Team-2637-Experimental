...
public class CatzDriveTrain
{
    ...
    private final double TALONFX_INTEGRATED_ENC_CNTS_PER_REV      = 2048;
    private final double DRVTRAIN_WHEEL_RADIUS                    = 2.8;
    ...
    private final double DRIVE_STRAIGHT_PID_TUNING_CONSTANT = 1.0;



    public final double PID_P = 0.1;   // original value was 0.05
    public final double PID_I = 0.0; // original value was 0.0005
    public final double PID_D = 0.0;      // original value was 0.1
    public final double PID_F = 0.055; //@mar7 0.02  // original value was 0.005    0.02 value for target speed 16000
    ...
    public void setDriveTrainPIDConfiguration() 
    {
         ...
         drvTrainMtrCtrlLTFrnt.config_kP(DRVTRAIN_VELOCITY_PID_IDX, PID_P);
         ...
         drvTrainMtrCtrlLTFrnt.config_IntegralZone(DRVTRAIN_VELOCITY_PID_IDX, PID_IZ);

         drvTrainMtrCtrlRTFrnt.config_kP(DRVTRAIN_VELOCITY_PID_IDX, PID_P);
         ...
         drvTrainMtrCtrlRTFrnt.config_IntegralZone(DRVTRAIN_VELOCITY_PID_IDX, PID_IZ); 
    }
    ...
    public void setTargetVelocity(double targetVelocity)
    {
        ...
        drvTrainMtrCtrlRTFrnt.set(TalonFXControlMode.Velocity, rightSetValue);//-DRIVE_STRAIGHT_PID_TUNING_CONSTANT**DRV_TRAIN_RT_CHANGE);
