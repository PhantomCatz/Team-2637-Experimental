...
public class CatzAutonomous
{
    ...
    public final double VELOCITY_DECREASE_RATE = 0.92; //original 0.98;

    public final double DISTANCE_CHANGER = 0.92;// 0.92;

    public double targetVelocity = 0.0;

    public  double maxSpeedFt = 0.0;
    ...
    ************************************************************************/
    ...
    public void driveStraight(double distance, double maxSpeed, double timeout)
    {
        ...
        distanceGoal = DISTANCE_CHANGER * Math.abs(distance); //in inches DISTANCE_CHANGER * 
           ...
           System.out.println("NavX:   " + Robot.navx.getAngle());
            ...
            if (Robot.dataCollection.isFirst == true)
            {
                ...
                data = new CatzLog(Robot.driveTrain.PID_P,Robot.driveTrain.PID_I,Robot.driveTrain.PID_D,
                            ...
                            Robot.driveTrain.DRV_TRAIN_RT_CHANGE, maxSpeedFt,
                            VELOCITY_DECREASE_RATE,Robot.pdp.getVoltage(),-999.0,-999.0,-999.0,-999.0);
